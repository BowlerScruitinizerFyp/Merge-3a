...
//                 double tangent = m2-m1/1-m1*m2;
            ...
            if(sin >= 1){
               ...
               tx1.setText("Distance 1 = " +dis1+ "\n Distance 2 ="+dis2+ "\n sine ="+sin + "\n theta = " +theta);
//
//                Intent intent = new Intent(getApplicationContext(), DemoAlertActivity.class);
//                intent.putExtra("angle", theta);
//
//
//                if (theta > 15){
//                    intent.putExtra("message", "Sorry Your angle of Bowling is not Legal");
//                }
//
//                else if(theta <= 15){
//                    intent.putExtra("message", "Hurray! Your angle of Bowling is not Legal");
//                }
//
//
...
//                startActivity(intent);
        ...
        Intent intent = new Intent(CameraActivity.this , DemoAlertActivity.class);

        intent.putExtra("theta" , angle);
